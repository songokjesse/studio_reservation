                ...
                <div class="p-6 text-gray-900 dark:text-gray-100">
                    ...
                    <form action="{{route('reservation.store')}}" method="POST">
                        ...
                        <div class="mt-3">
                            ...
                            <input name="start_time" value="{{old('start_time')}}" class="@error('start_time') border-red-500 @enderror shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" id="start_time" type="datetime-local" placeholder="Start Time">
                            @error('start_time')
                            <div class="text-sm text-red-600">{{ $message }}</div>
                            @enderror
                        </div>
